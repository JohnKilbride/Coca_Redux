...
def main():
    ...
    chp_dir = "/home/john/datasets/coca_data_2022/warping_128/Unet-jaccard-timm-resnest50d-0.0075-0.0-128-128-Geo+Noise/version_0/checkpoints"
    model_path = chp_dir + '/' + 'epoch=99-step=26799.ckpt'
    
    # Create the args to loop over
    arg_list = []
    # for year in range(1, 2020):
    for i, year in enumerate([2003, 2019]):
        if i % 2 == 0:
            device = 0
        else:
            device = 1
